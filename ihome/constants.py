...
# 上传图片保存
# QINIU_URL_DOMAIN = "http://qyddgfu69.hd-bkt.clouddn.com/"  下面的改成在本地保存
img_path = os.path.abspath(os.path.dirname(__file__))
IMG_URL_DOMAIN = "/static/upload/"
...
# 支付宝的网关地址（支付地址域名）
ALIPAY_URL_PREFIX = "https://openapi.alipaydev.com/gateway.do?"  # https://openapi.alipaydev.com/gateway.do
